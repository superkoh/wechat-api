...
@Data
public class WxVoiceReply extends WxReply {
  ...
  public static class Builder extends WxReplyBuilder<WxVoiceReply, Builder> {

    @Override
    protected WxVoiceReply newInstance() {
      return new WxVoiceReply();
    }
